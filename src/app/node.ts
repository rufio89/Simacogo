...
export class Node {
  ...
  generateSuccessors(player): Array<Node>{
    ...
    // if(row6!=null){children.push(new Node(this, row6, "row6", row4.getPlayer1Score(), row4.getPlayer2Score()))};
    // if(row7!=null){children.push(new Node(this, row7, "row7", row4.getPlayer1Score(), row4.getPlayer2Score()))};
    // if(row8!=null){children.push(new Node(this, row8, "row8", row4.getPlayer1Score(), row4.getPlayer2Score()))};
    // if(row9!=null){children.push(new Node(this, row9, "row9", row4.getPlayer1Score(), row4.getPlayer2Score()))};
